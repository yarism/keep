...
contextBridge.exposeInMainWorld('git', {
  ...
  setAppIcon: (i) => ipcRenderer.invoke('set-app-icon', i),
  ...
  addRemote: (p, name, url) => ipcRenderer.invoke('git-add-remote', p, name, url),
  setRemoteUrl: (p, name, url) => ipcRenderer.invoke('git-set-remote-url', p, name, url),
  removeRemote: (p, name) => ipcRenderer.invoke('git-remove-remote', p, name),
  deleteRemoteBranch: (p, remote, branch) => ipcRenderer.invoke('git-delete-remote-branch', p, remote, branch),
  ...
  checkoutTracking: (p, remoteBranch) => ipcRenderer.invoke('git-checkout-tracking', p, remoteBranch),
  deleteBranch: (p, name, opts) => ipcRenderer.invoke('git-delete-branch', p, name, opts),
  ...
  reset: (p, hash) => ipcRenderer.invoke('git-reset', p, hash),
