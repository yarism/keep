...
ipcMain.handle('git-checkout-tracking', (_, repoPath, remoteBranch) => git.checkoutTracking(repoPath, remoteBranch));
ipcMain.handle('git-delete-branch', (_, repoPath, name, opts) => git.deleteBranch(repoPath, name, opts));
...
ipcMain.handle('git-reset', (_, repoPath, hash) => git.reset(repoPath, hash));
