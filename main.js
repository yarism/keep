...
ipcMain.handle('forge-react', (_, repoPath, forge, opts) => forgeApi.reactToComment(repoPath, forge, opts));
ipcMain.handle('forge-comment-reactions', (_, repoPath, forge, commentId) => forgeApi.listCommentReactions(repoPath, forge, { commentId }));
